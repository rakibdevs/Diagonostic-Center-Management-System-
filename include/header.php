		                  ...
		                  <li >
		                      ...
		                      <div id="subPages4" class="collapse">
		                       <ul class="nav">
		                          ...
		                          <li><a <?php if($_GET['active'] == 'add_expense'){echo 'class="active"';} ?> href="addexpense.php?active=add_expense">Add Expense</a></li>
		                          <li><a <?php if($_GET['active'] == 'todays_expense'){echo 'class="active"';} ?> href="todays_expense.php?active=todays_expense">Today's Expense</a></li>
		                          <li><a <?php if($_GET['active'] == 'expense'){echo 'class="active"';} ?> href="expense_list.php?active=expense">All Expense</a></li>
		                      </ul>
		                  </li>
		                  <li >
