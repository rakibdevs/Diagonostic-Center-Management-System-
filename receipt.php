												        	...
												        	<div class="form-group">
												        	 ...
												        	 <p> <span>Name of Patient: </span>  </p>
												        		...
												        		<p>
												        		 <span>Sex : </span> 
												        		 <label>
											                    	<input type="radio" name="sex_" id="male" value="Male" onclick="function_sex('', 'Male')">
											                    	Male  
											                    
											                    
											                     	<input type="radio" name="sex_" id="female" value="Female" onclick="function_sex('', 'Female')">
											                     	Female 
											                    
											                    
											                     	<input type="radio"  name="sex_" id="others" value="Others"  onclick="function_sex('', 'Others')">
											                     	Others
											                   ...
											                   <div class="row-div">
													                ...
													                <span class="input-group-addon"><i class="fa fa-user"></i></span>
													                <input type="text" class="input-control" placeholder="C/O" name="co_" id="co_" onkeydown="co('')" autoComplete="off" value="" ><span class="input-group-addon loading_co" style="display:none"><img src="img/broken_circle.gif" width="18" height="18" /></span>
													            </div>
													            <div class="input-group">
													                <span class="input-group-addon"><i class="fa fa-user-md"></i></span>
													                <input type="text" class="input-control" placeholder="Refd By" name="refdby_" id="RefdBy_" onkeydown="refdby('')" autoComplete="off" value="" ><span class="input-group-addon loading_rfd" style="display:none"><img src="img/broken_circle.gif" width="18" height="18" /></span>
													            </div>
											              	</div>
											              </div>
							          	...
							          	<div class="panel panel-default">
							          	    <div class="panel-body">
							          	        <div class="input-group" style="display:block;box-shadow:none; margin-bottom:10px;">
									                <span class="" style="width:30%; text-align: left; float:left;">Delivery Time</span>
									                <textarea class="input-control" style="margin:0;width:70%;" name="deli_time_" id="deli_time_"></textarea>
									            </div>

									            <div align="center">
						                        	<button class="btn btn-danger" onclick="return cancelInvoice('')">Cancel Invoice</button>
						                        	<button class="btn btn-primary" onclick="return confirmInvoice('')">Confirm Invoice</button>
						                        </div>
								            </div>
		                                </div>
				          			...
				          			<div class="col-lg-8">
							          	...
							          	<div class="panel panel-default">
							          	    <div class="panel-body">
							          	        <div class="input-group" style="display:block;box-shadow:none; margin-bottom:10px;">
									                <span class="" style="width:30%; text-align: left; float:left;">Delivery Time</span>
									                <textarea class="input-control" style="margin:0;width:70%;" name="deli_time_<?php echo $mainIndex; ?>" id="deli_time_<?php echo $mainIndex; ?>"></textarea>
									            </div>

									            <div align="center">
						                        	<button class="btn btn-danger" onclick="return cancelInvoice('<?php echo $mainIndex; ?>')">Cancel Invoice</button>
						                        	<button class="btn btn-primary" onclick="return confirmInvoice('<?php echo $mainIndex; ?>')">Confirm Invoice</button>
						                        </div>
								            </div>
		                                </div>
